...
Module variables
    ...
    Public Property api_network1_hosts() = {"https://scanner1.mining.moe/api", "http://scanner1.alwayshashing.com:8085/api", "https://scanner.vtconline.org/api"}
    Public Property api_network2_hosts() = {"https://scanner2.mining.moe/api", "http://scanner2.alwayshashing.com:8086/api"}
    Public Property networkdata As DataSet
